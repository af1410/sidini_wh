    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Form Tambah Orang Tua</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.ortu.store') }}" method="POST">
                    @csrf
                    <div class="row gy-3">
                        <div class="col-md-6">
                    ...
                    <div class="alert alert-info mt-3">
                        ...
                        <strong>Catatan:</strong> Username dan password akan otomatis di-generate dari nomor HP.
                    </div>
