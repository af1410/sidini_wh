        ...
        <div class="card mb-4">
            <div class="card-header bg-light">
                @foreach ($kelas->mapels as $mapel)
                    <h4 class="fw-bold mb-2">{{ $mapel->nama_mapel }}</h4>
                    <h6 class="fw-bold mb-2">{{ $kelas->nama_kelas }}</h6>
                @endforeach
            </div>
            ...
            <div class="card-body">
                ...
                <p class="mb-0">
                    ...
                    {{ $penilaian->semester ?? 'Belum ditentukan' }}
                </p>
                        ...
                        <table class="table table-hover table-bordered align-middle mb-0">
                            ...
                            <tbody>
                                @foreach ($kelas->siswas as $index => $item)
                                    @php
                                        $presensi = isset($presensiHariIni) ? $presensiHariIni->get($item->id_siswa) : null;
                                    @endphp
                                    <tr>
                                        <td>{{ $index + 1 }}</td>
                                        <td>{{ $item->nim }}</td>
