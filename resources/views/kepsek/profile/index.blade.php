...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('kepsek.profile.edit') }}" class="btn btn-primary">
            ...
            <div class="col-lg-4">
                <div class="card border-0 shadow-sm overflow-hidden">
                    ...
                    <div class="card-body text-center mt-n5">
                        ...
                        @if ($kepsek->gambar)
                            <img src="{{ asset('storage/' . $kepsek->gambar) }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="fw-semibold">
                                        {{ \Carbon\Carbon::parse($kepsek->tanggal_lahir)->translatedFormat('d F Y') }}
                                    </div>
                                </div>
